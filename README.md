...
- Analyze **weekly transaction trends**
...
This dashboard focuses on **overall customer performance and spending distribution**.
...
- Transaction Amount by Customer Age Group
...
- `01_customer_performance_overview.png` – Customer Performance Dashboard overview  
- `02_customer_performance_filtered.png` – Customer Performance with filters applied  
...
- Average transaction value differs noticeably by gender
